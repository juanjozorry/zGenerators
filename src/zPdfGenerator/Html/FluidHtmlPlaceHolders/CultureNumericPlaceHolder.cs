...
namespace zPdfGenerator.Html.FluidHtmlPlaceHolders
{
    ...
    public class CultureNumericPlaceHolder<T> : CultureBasePlaceHolder<T>
    {
        /// <summary>
        ...
        public CultureNumericPlaceHolder(string name, Func<T, decimal?> map, string stringFormat = "N", CultureInfo? overrideGlobalCultureInfo = null) 
